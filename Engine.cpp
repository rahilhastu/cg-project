...
is set, displays the model twice, 1st time accepting those fragments
with a ALPHA value of 1 only, then with DEPTH_BUFFER writing disabled
for those with other values. */
...
/* Initialises lighting, display lists, and everything else
...
Sets system in Double Buffered mode and initialises all the callback
functions. */
